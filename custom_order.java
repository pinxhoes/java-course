...
public class custom_order {
   ...
   double tax; // Amount of tax// STEP 2 CREATE A SCANNER OBEJCT, DECLARE VARAIBLES, & PRINT STATEMENTS



    System.out.println("Welcome to Java's Cake & Cupcake Shop!");
    System.out.println("We make custom cakes with our secret cake batter!");// Introduce shop and prompt user to input first name
    ...
    System.out.print("\n"); // skips a line	 // STEP 3 INPUT YOUR NAME AND PREPARE TO VIEW MENU
...
System.out.println("_______________________________________________");// STEP 4 DISPLAY MENU
...
itemOrder = keyboard.nextLine();// STEP 5 PROMPT USER TO ORDER
...
frostingType = keyboard.nextLine();// STEP 6 PROMPT USER TO CHOOSE FROSTING
...
fillingType = keyboard.nextLine();// STEP 7 PROMPT USER TO CHOOSE FILLING
...
toppings = keyboard.nextLine();// STEP 8 PROMPT USER TO CHOOSE TOPPINGS
...
System.out.println("_________________________________________");// STEP 9 DISPLAY ORDER CONFIRMATION
...
System.out.printf("The total due is: $%.2f\n",(tax + cost));// STEP 10 DISPLAY COST AND SALES TAX
